...
# set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 PULLDOWN TRUE} [get_ports { row[0] }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
# set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 PULLDOWN TRUE} [get_ports { row[1] }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
# set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 PULLDOWN TRUE} [get_ports { row[2] }]; #IO_L22P_T3_34 Sch=ja_p[4]
# set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 PULLDOWN TRUE} [get_ports { row[3] }]; #IO_L22N_T3_34 Sch=ja_n[4]

## Pmod Header JB
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { motor_pwm }]; #IO_L8P_T1_34 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { dir[0] }]; #IO_L8N_T1_34 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { dir[1] }]; #IO_L1P_T0_34 Sch=jb_p[2]
# set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { btn[3] }]; #IO_L1N_T0_34 Sch=jb_n[2]
# set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { btn[4] }]; #IO_L18P_T2_34 Sch=jb_p[3]
...
# set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { led_row[0] }]; #IO_L6N_T0_VREF_35 Sch=ck_a[0]
# set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports { led_row[1] }]; #IO_L10N_T1_AD11N_35 Sch=ck_a[1]
# set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { led_row[2] }]; #IO_L12P_T1_MRCC_35 Sch=ck_a[2]
# set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { led_row[3] }]; #IO_L11P_T1_SRCC_35 Sch=ck_a[3]
# set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { led_row[4] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=ck_a[4]
# set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { led_row[5] }]; #IO_L6P_T0_34 Sch=ck_a[5]
...
# set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports { led_row[6] }]; #IO_L1P_T0_AD0P_35 Sch=ad_p[0]
# set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { led_row[7] }]; #IO_L1N_T0_AD0N_35 Sch=ad_n[0]
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { btn[0] }]; #IO_L11P_T1_SRCC_34 Sch=ck_io[0]
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L3N_T0_DQS_34 Sch=ck_io[1]
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { btn[2] }]; #IO_L5P_T0_34 Sch=ck_io[2]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { btn[3] }]; #IO_L5N_T0_34 Sch=ck_io[3]
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { led_bar[0] }]; #IO_L21P_T3_DQS_34 Sch=ck_io[4]
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { led_bar[1] }]; #IO_L21N_T3_DQS_34 Sch=ck_io[5]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { led_bar[2] }]; #IO_L19N_T3_VREF_34 Sch=ck_io[6]
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { led_bar[3] }]; #IO_L6N_T0_VREF_34 Sch=ck_io[7]
set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { led_bar[4] }]; #IO_L13P_T2_MRCC_34 Sch=ck_io[8]
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { led_bar[5] }]; #IO_L8N_T1_AD10N_35 Sch=ck_io[9]
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { led_bar[6] }]; #IO_L11N_T1_SRCC_34 Sch=ck_io[10]
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { led_bar[7] }]; #IO_L12N_T1_MRCC_35 Sch=ck_io[11]
# set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { led_bar[4] }]; #IO_L14P_T2_AD4P_SRCC_35 Sch=ck_io[12]
# set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { motor_pwm }]; #IO_L19N_T3_VREF_35 Sch=ck_io[13]

## ChipKit Inner Digital Header
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { echo }]; #IO_L19P_T3_34 Sch=ck_io[26]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { trig }]; #IO_L2N_T0_34 Sch=ck_io[27]
...
# set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { dht11_data }]; #IO_L20N_T3_34 Sch=ck_io[33]
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { seg_7[0] }]; #IO_L23N_T3_34 Sch=ck_io[34]
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { seg_7[1] }]; #IO_L23P_T3_34 Sch=ck_io[35]
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { seg_7[2] }]; #IO_L8P_T1_AD10P_35 Sch=ck_io[36]
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { seg_7[3] }]; #IO_L11N_T1_SRCC_35 Sch=ck_io[37]
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { seg_7[4] }]; #IO_L13N_T2_MRCC_35 Sch=ck_io[38]
set_property -dict { PACKAGE_PIN H18   IOSTANDARD LVCMOS33 } [get_ports { seg_7[5] }]; #IO_L14N_T2_AD4N_SRCC_35 Sch=ck_io[39]
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { seg_7[6] }]; #IO_L16N_T2_35 Sch=ck_io[40]
set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS33 } [get_ports { seg_7[7] }]; #IO_L9N_T1_DQS_AD3N_35 Sch=ck_io[41]
